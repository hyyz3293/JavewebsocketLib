...
import com.jack.websocket.WebSocketSetting;
import com.jack.websocket.request.FrameDataRequest;
...
public interface IResponseDispatcher {
     ...
     * 连接断开 --次數 ---jack 新增得到
     */
    void onReConnectCount(int count, ResponseDelivery delivery);

    /**
     * 接收到文本消息
     *
     * @param message  接收到的消息n
