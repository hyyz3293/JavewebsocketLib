package com.jack.websocket.keeplive.service;
...
import com.jack.websocket.R;
import com.jack.websocket.keeplive.KeepLive;
import com.jack.websocket.keeplive.config.NotificationUtils;
import com.jack.websocket.keeplive.receiver.NotificationClickReceiver;
import com.jack.websocket.keeplive.receiver.OnepxReceiver;
import com.jack.websocket.keeplive.utils.ServiceUtils;
...
public final class LocalService extends Service {
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName name) {
            if (ServiceUtils.isServiceRunning(getApplicationContext(), "com.jack.websocket.keeplive.service.LocalService")){
